...
import { blogAdminAnalyticsPath, blogAdminBlogPath } from "@/lib/blog/urls";
...
export default function CmsHub({ overview: initialOverview, posts }: CmsHubProps) {
...
function HubToolbar({ active, live }: { active: "blog" | "analytics"; live?: boolean }) {
  return (
