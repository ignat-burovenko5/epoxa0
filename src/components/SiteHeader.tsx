...
const navContactLinkClass =
  "contact-link-animated contact-enter group grid grid-cols-[1.75rem_1fr] gap-x-2 items-center text-museum-light hover:text-white transition-colors duration-300 py-0";

const navIconSlotClass =
  "contact-icon-ring flex h-6 w-6 items-center justify-center justify-self-start rounded-full border border-transparent text-accent-gold/90";

const navContactTextClass =
  "font-serif text-[0.9375rem] lg:text-[1.0625rem] leading-none whitespace-nowrap tracking-[0.01em]";
          ...
          <div className="hidden md:flex flex-col justify-center gap-1">
            ...
            >
              <span className={navIconSlotClass}>
                <EmailIcon className="h-3.5 w-3.5 lg:h-4 lg:w-4" />
              </span>
              <span
            ...
            >
              <span className={navIconSlotClass}>
                <PhoneIcon className="h-3.5 w-3.5 lg:h-4 lg:w-4" />
              </span>
